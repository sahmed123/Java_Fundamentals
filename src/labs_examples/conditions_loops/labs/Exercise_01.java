...
public class Exercise_01 {
    ...
    public static void main(String[] args) {
        ...
        if(number >= 1 && number <= 1000000) {
            if (number % 2 == 0) {
                System.out.println("The number that was inputted is even.");
            } else
                System.out.println("The number that was inputted is odd.");
        }else
            System.out.println("You have inputted a number that is outside of our range. Please try again.");
    }
}
